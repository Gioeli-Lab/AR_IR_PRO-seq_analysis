...
```{r  out.height = "300px", out.width = "800px", fig.align = 'left', echo=F, fig.cap="Figure 1D"}
#library(knitr)
...
#library(knitr)
knitr::include_graphics("./Figures/P53.png") 
```
...
#library(knitr)
knitr::include_graphics("./Figures/P53_fimo_barchart_batch1.pdf") 
```
