...
This first experiment (batch 1) had 4 replicates each of irradiated or mock-treated cells.
...
```{r engine='bash', eval=F, echo=TRUE}
#Download the P53 motif file if you don't have it already
...
We don't have P53 ChIP-seq data from LNCaP cells, but we used ENCODE data from two other cell lines and found similar results. Here we download P53 ChIP-seq peaks from A549 cells as a bed file. 
