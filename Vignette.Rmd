...
```{r  out.height = "300px", out.width = "800px", fig.align = 'left', echo=F, fig.cap="Figure 1B"}
#library(knitr)
...
```{r  out.height = "300px", out.width = "800px", fig.align = 'left', echo=F, fig.cap="Figure 1C"}
#library(knitr)
knitr::include_graphics("./Figures/Heatmap_batch1_recount.pdf") 
```
...
```{r  out.height = "600px", out.width = "800px", fig.align = 'left', echo=F, fig.cap="Figure 1D"}
#library(knitr)
knitr::include_graphics("./Figures/Radiation_Volcano_batch1_recount.pdf") 
```
...
```{r  out.height = "300px", out.width = "800px", fig.align = 'left', echo=F, fig.cap="Figure 1E"}
#library(knitr)
knitr::include_graphics("./Figures/Hallmark_GSEA_batch1_FDR_0.05_recount.pdf") 
```
...
```{r  out.height = "300px", out.width = "800px", fig.align = 'left', echo=F, fig.cap="Figure 1F"}
#library(knitr)
knitr::include_graphics("./Figures/P53.eps") 
```
...
```{r  out.height = "300px", out.width = "800px", fig.align = 'left', echo=F, fig.cap="Figure 1G"}
#library(knitr)
knitr::include_graphics("./Figures/P53_fimo_barchart_batch1_recount.pdf") 
```
