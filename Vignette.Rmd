...
## Volcano plot (Figure 1D and Table S1)
...
## Volcano plots (Figure 2E-H and Tables S2,3) and MA plots (Figure S1)
...
## Proximity analysis between enzalutamide-repressed genes and AR ChIP-seq peaks(Figure 2I)
...
## Proximity analysis between radiation-activated genes and P53 ChIP-seq peaks(Figure 2J)
...
## Proximity analysis between radiation-responsive genes and AR ChIP-seq peaks(Figure 2K)
...
## Plot expression of enzalutamide-repressed radiation-activated genes (Figure 3A) 
...
## Plot expression of enzalutamide-activated radiation-activated genes (Figure S2A) 
...
## Plot expression of enzalutamide-represed radiation-repressed genes (Figure S2B) 
...
## Plot expression of enzalutamide-activated radiation-repressed genes (Figure S2C) 
...
## Over-representation analysis (ORA) of gene classes (Figure S2D)
...
## Radiation-activated genes composite plot (Figure 3B)
...
## Enzalutamide-repressed genes composite plot (Figure 3D)
...
## Pause ratio analysis for above gene classes (Figure 3C,E)
