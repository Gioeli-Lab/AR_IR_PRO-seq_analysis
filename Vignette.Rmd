...
I don't think we need the initial "source" command, as the following function list should be complete. 
...
## Identify differentially expressed genes for experiment 2 (combination treatments)
